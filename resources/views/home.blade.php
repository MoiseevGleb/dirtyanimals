    ...
    <div class="container">
        ...
        <div class="crew__list">
            <div class="crew__item">
                <img src="{{ asset('storage/images/crew/gleb.jpg') }}" alt="gleb.png" class="crew__item-img">
            ...
            <div class="crew__item">
                <img src="{{ asset('storage/images/crew/leha.jpg') }}" alt="leha.jpg" class="crew__item-img">
            ...
            <div class="crew__item">
                <img src="{{ asset('storage/images/crew/artem.jpg') }}" alt="artem.jpg" class="crew__item-img">
            ...
            <div class="crew__item">
                <img src="{{ asset('storage/images/crew/igor.jpg') }}" alt="igor.jpg" class="crew__item-img">
    ...
    <div class="container">
        ...
        <ol class="concert__cities">
            @foreach ($concerts as $i => $concert)
                <li class="concert__city">   {!! Carbon\Carbon::now()->addDay($i)->translatedFormat('d F, 20:00') !!} - {{ $concert->city }}</li>
            @endforeach
        </ol>
    </div>
</section>
